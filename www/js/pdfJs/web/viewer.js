            ...
            case 3:
              ...
              return _context7.abrupt('return', loadingTask.promise.then(function (pdfDocument) {
                ...
                return loadingErrorMessage.then(function (msg) {
                  ...
                  alert("Gagal ketika mengambil dokument");
                  throw new Error(msg);
                });
              }));
...
document.addEventListener('pagesloaded', function(e) { 
  ...
  console.log(pgNum);
  if(window.parent.checkBookmark(pgNum)){
    document.getElementById('viewBookmark').classList.add("on");
  } else {
    document.getElementById('viewBookmark').classList.remove("on");
  }
});
document.addEventListener('pagechange', function(e) { 
  
  if(window.parent.checkBookmark(e.pageNumber)){
    document.getElementById('viewBookmark').classList.add("on");
  } else {
    document.getElementById('viewBookmark').classList.remove("on");
  }
